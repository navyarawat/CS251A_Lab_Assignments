...
int main(int argc, char** argv){
	...
	//divide the work into the threads as follows:
	//thread zero checks the indices 0,thrdcnt,2thrdcnt,3thrdcnt....
	//thread one checks the indices 1,t+1,2t+1,3t+1.... and so on.
