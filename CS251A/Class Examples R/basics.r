a <- 5
a               #prints 'a' onto the console
class(a)        #maybe prints the 'variable type', the class in which 'a' belongs
str(a)          #say whaaaaaat
print(a)
...
a <- (1:5)      #i dont think it prints anything
class(a)
print(a)
#
a[6] = 98.3
...
regs <- c(110, 90, 70)          #c stands for combine
drops <- c(5, 3, 1)
